...
#define RelayLED 12
#define analogchannel A0 // Connect current sensor

int sensitivity = 185; // ACS713-05B has 185mV/A
int offsetvoltage = 2500; // 2.5V in millivolts

float adcvalue = 0;
double Voltage = 0; 
double ecurrent = 0;
unsigned long previousMillis = 0; // Timer variable
const long interval = 300; // Update every 300ms
